...
@app.on_message(
    filters.command(["play", "vplay", "cplay", "cvplay", "playforce", "vplayforce", "cplayforce", "cvplayforce", "oynat", "voynat", "coynat", "cvoynat", "oynatforce", "voynatforce", "coynatforce", "cvoynatforce"] ,prefixes=["/", ""])
    & filters.group
    & ~BANNED_USERS
)
@PlayWrapper
